...
typedef enum _SRConstLoadAdditionalDataType {
    ...
    SR_LOAD_ADDITIONAL_DATA_SEASON_TOP_DISCIPLINARIES   = 1 << 17,
    SR_LOAD_ADDITIONAL_DATA_SEASON_TOP_OWN_GOALS        = 1 << 18,
    SR_LOAD_ADDITIONAL_DATA_SEASON_TOP_POINTS           = 1 << 19,
    SR_LOAD_ADDITIONAL_DATA_SEASON_TOP_STATS            = SR_LOAD_ADDITIONAL_DATA_SEASON_TOP_ASSISTS | SR_LOAD_ADDITIONAL_DATA_SEASON_TOP_CARDS | SR_LOAD_ADDITIONAL_DATA_SEASON_TOP_GOALS | SR_LOAD_ADDITIONAL_DATA_SEASON_TOP_DISCIPLINARIES | SR_LOAD_ADDITIONAL_DATA_SEASON_TOP_OWN_GOALS | SR_LOAD_ADDITIONAL_DATA_SEASON_TOP_POINTS,
    SR_LOAD_ADDITIONAL_DATA_TEAM_LAST_MATCHES           = 1 << 20,
    SR_LOAD_ADDITIONAL_DATA_TEAM_NEXT_MATCHES           = 1 << 21,
    SR_LOAD_ADDITIONAL_DATA_TOURNAMENT_TENNIS_INFO      = 1 << 22,
    SR_LOAD_ADDITIONAL_DATA_TEAM_TENNIS_GROUND_STATS    = 1 << 23,
    SR_LOAD_ADDITIONAL_DATA_ALL                         = (1 << 24) - 1,
